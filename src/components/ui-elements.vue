    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><i class="fa fa-gear"></i> <strong>SYSTEM NAME</strong></a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#/ui_elements" class="active-menu"><i class="fa fa-desktop"></i> UI Elements</a>
                    </li>
					<li>
...
<div class="progress progress-striped">
  ...
  <div class="progress-bar progress-bar-danger" style="width: 10%">
    <span class="sr-only">10% Complete (danger)</span>
                ...
                <!-- /. ROW  -->
				<footer><p>Copyright &copy; 2018.Company name All rights reserved.More Templates </p></footer>
				</div>
             <!-- /. PAGE INNER  -->
            </div>
         <!-- /. PAGE WRAPPER  -->
